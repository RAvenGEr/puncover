...
/Users/behrens/Documents/projects/pebble/puncover/pebble/build/../src/puncover.c:19
 8a8:	b508      	push	{r3, lr}
    ...
    def test_enhance_file_elements(self):
        ...
        self.assertEqual([aa, ab], a[collector.SUB_FOLDERS])
        self.assertEqual([], aa[collector.SUB_FOLDERS])
        self.assertEqual([], ab[collector.SUB_FOLDERS])
        self.assertEqual([ba], b[collector.SUB_FOLDERS])
        self.assertEqual([baa], ba[collector.SUB_FOLDERS])
        self.assertEqual([], baa[collector.SUB_FOLDERS])

        self.assertEqual([], a[collector.FILES])
        self.assertEqual([aa_c], aa[collector.FILES])
        self.assertEqual([ab_c], ab[collector.FILES])
        self.assertEqual([b_c], b[collector.FILES])
        self.assertEqual([], ba[collector.FILES])
        self.assertEqual([baa_c], baa[collector.FILES])
        ...
        self.assertEqual([aa, ab], a[collector.COLLAPSED_SUB_FOLDERS])
        self.assertEqual([], aa[collector.COLLAPSED_SUB_FOLDERS])
        self.assertEqual([], ab[collector.COLLAPSED_SUB_FOLDERS])
        self.assertEqual([baa], b[collector.COLLAPSED_SUB_FOLDERS])
        self.assertEqual([baa], ba[collector.COLLAPSED_SUB_FOLDERS])
        self.assertEqual([], baa[collector.COLLAPSED_SUB_FOLDERS])
